<template>
  <div class="app">
    ...
    <el-divider content-position="left"><b>截取范围</b></el-divider>
    <el-input v-model="subPipe" placeholder="截管长度" @focus="focus(1)">
      <template #append> cm </template>
    </el-input>
    请在此输入切割长度，以空格分隔

    <el-divider content-position="left"><b>原料长度</b></el-divider>
    <el-input v-model="rawPipe" placeholder="原料长度" @focus="focus(2)">
      <template #append> cm </template>
    </el-input>
    请在此输入原料长度，以空格分隔

    <el-divider content-position="left"><b>算法选择</b></el-divider>
    ...
    <el-divider style="padding-bottom: 10px"><b>截取结果</b></el-divider>
